...
Furthermore, we make available an R package \textit{dobin} \citep{dobin}, which computes the DOBIN basis. We start the next section  with the mathematical framework of DOBIN. % in Section~\ref{sec:MathFrame}.    
...
\noindent
Next we establish the $Y$ space, which is instrumental is the construction of DOBIN.
