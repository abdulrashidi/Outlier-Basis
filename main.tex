...
\begin{equation}\label{eq:ResWithVis1}
    ...
    \end{bmatrix}
\end{equation}
From equation~\eqref{eq:ResWithVis1} we see that \textit{Population Density} is the main variable contributing to the strong outliers identified in the O3 plot as well as in the DC1-DC2 space. This insight gives us a better understanding of the dataset. 
