...
Figure~\ref{fig:LOF_FAT2} shows the boxplots of performance differences between each of $1/2$ DOBIN and $1/2$ PCA with All Vars. %Taking into account that all performance values are roughly between $0.4$ and $1$,  we see that $1/2$ DOBIN has a higher median AUC, and a higher third quartile compared to $1/2$ PCA and All Vars.
