...
From the statisticians point of view outlier detection is mainly an unsupervised task. However, the computer scientists have a more flexible view on the matter. While unsupervised outlier detection is quite popular, to identify more targeted outliers, some use  semi-supervised and supervised methodologies. A brief description about these three outlier detection categories is given in \cite{goldstein2016comparative}. \\
...
Points \\
%Coming together of statisticians and ML researchers \\
%Different types of outlier detection \\
